export default {
    ...
    admin_login_subtitle: "Vui lòng nhập thông tin để truy cập bảng điều khiển.",
    email: "Email",
    ...
    admin_dashboard_orders_count: "Số lượng đơn",
    admin_dashboard_summary_mobile: "Người dùng Mobile",
    admin_dashboard_summary_new_users: "Người dùng mới",
    ...
    admin_placeholder_option_name_custom: "Nhập tên tùy chỉnh (VD: Chất liệu)",
    ...
    admin_msg_upload_success: "Tải ảnh lên thành công!",
    admin_msg_options_success: "Cấu hình phân loại thành công!",
    admin_msg_variants_success: "Lưu phân loại chi tiết thành công!",
    ...
    admin_error_brand_required: "Vui lòng chọn thương hiệu!",
    admin_placeholder_brand: "Chọn thương hiệu",
    ...
    invoice_thanks: "Cảm ơn quý khách đã tin dùng sản phẩm của Bkeuty!",
    ...
    admin_review_product_select: "Chọn sản phẩm để xem đánh giá",
    admin_review_reply_placeholder: "Nhập nội dung phản hồi...",
    ...
    admin_review_delete_review_confirm_title: "Xác nhận xóa đánh giá",
    admin_review_delete_review_confirm_content: "Bạn có chắc chắn muốn xóa đánh giá này không? Hành động này không thể hoàn tác.",
    admin_review_no_data: "Chưa có đánh giá nào cho sản phẩm này.",
    admin_review_reply_btn: "Phản hồi",
    admin_review_view_btn: "Xem đánh giá",
    admin_review_select_product_hint: "Vui lòng chọn sản phẩm để quản lý đánh giá",
    admin_review_reply_modal_title_add: "Phản hồi đánh giá",
    admin_review_reply_modal_title_edit: "Chỉnh sửa phản hồi",
    admin_review_reply_label: "Nội dung phản hồi của bạn",
