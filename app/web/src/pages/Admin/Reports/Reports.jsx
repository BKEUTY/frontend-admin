...
import { PageWrapper, CButton } from '../../../Component/Common';
            ...
            <PageWrapper
                ...
                extra={
                    <Space size="middle" wrap>
                        ...
                        <Segmented
                            options={[
                                { label: '7 ' + t('page').toLowerCase(), value: 'week' },
                                { label: '30 ' + t('page').toLowerCase(), value: 'month' },
                                { label: '90 ' + t('page').toLowerCase(), value: 'quarter' }
                            ]}
                            value={timeRange}
                        ...
                        <Col xs={24}>
                            <div className="admin-glass-card">
                                ...
                                <Table
                                    ...
                                    columns={[
                                        { title: t('admin_product_brand'), dataIndex: 'brand', key: 'brand', render: (t) => <Text strong>{t || 'N/A'}</Text> },
